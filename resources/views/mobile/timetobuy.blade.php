...
@section('content')
  ...
  <div class="tuaninfo clearfix overh bgc_f">
    ...
    <div class="ti_right overh f-l">
      ...
      <div class="ti_r_b overh bgc_sr">
        <del>原价：￥{{ $good->shop_price }}</del> 团购价：<span class="font_md">￥{{ $timetobuy->price }}</span>
      </div>
    </div>
  </div>
  <!-- 产品信息 -->
  <section class="goodinfo clearfix mt20 bgc_f pd20">
    ...
    <div class="g_i_prices mt10 clearfix">
      <span class="gi_price font_lg color_main f-l">￥<i class="shop_price">{{ $timetobuy->price }}</i></span>
  ...
  <div class="submit_con hidden">
    <form action="javascript:;" class="form_data">
      ...
      <!-- 价格 -->
      <input type="text" name="shop_price" class="price" value="{{ $timetobuy->price }}">
    </form>
    <!-- 购物车、直接买 -->
    <script>
      $(function(){
