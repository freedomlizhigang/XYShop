<form action="javascript:;" method="post" id="form_ajax">
    ...
    <table class="table table-striped">
        ...
        <tr>
            <td class="td_left">满多少赠：</td>
            <td>
                <input type="number" name="data[price]" min="0" value="{{ $info->price }}" class="form-control input-sm">
        ...
        <tr>
            ...
            <td>
                <input type="number" name="data[store]" min="0" value="{{ $info->store }}" class="form-control input-sm">
                <p class="input-info"><span class="color_red">*</span>数字</p>
            </td>
        </tr>
    ...
    <div class="modal-footer">
        ...
        <div onclick='ajax_submit_form("form_ajax","{{ url('/console/manzeng/edit',['id'=>$info->id]) }}")' name="dosubmit" class="btn btn-info">提交</div>
    </div>
