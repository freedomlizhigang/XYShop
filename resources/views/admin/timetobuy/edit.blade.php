...
<form action="javascript:;" method="post" id="form_ajax">
    ...
    <table class="table table-striped">
        <tr>
            ...
            <td>
                <input type="text" name="data[title]" value="{{ $info->title }}" class="form-control input-md">
        ...
        <tr>
            ...
            <td>
                <input type="text" name="data[price]" value="{{ $info->price }}" class="form-control input-xs">
        ...
        <tr>
            ...
            <td>
                <input type="number" min="0" name="data[good_num]" value="{{ $info->good_num }}" class="form-control input-xs">
        ...
        <tr>
            ...
            <td>
                <input type="number" min="0" name="data[buy_max]" value="{{ $info->buy_max }}" class="form-control input-xs">
        ...
        <tr>
            ...
            <td>
                <textarea name="data[describe]" id="" class="form-control input-md" rows="5">{{ $info->describe }}</textarea>
        ...
        <tr>
            ...
            <td>
                <div class="btn-group">
                    ...
                    <div onclick='ajax_submit_form("form_ajax","{{ url('/console/timetobuy/edit',['id'=>$info->id]) }}")' name="dosubmit" class="btn btn-xs btn-info">提交</div>
                </div>
            </td>
        </tr>
