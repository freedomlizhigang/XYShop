<form action="javascript:ajax_submit();" method="post" id="form_ajax">
    ...
    <table class="table table-striped">
        ...
        <tr>
            ...
            <td>
                <input type="text" name="data[points]" class="form-control input-sm" value="{{ $info->points }}">
        ...
        <tr>
            ...
            <td>
                <input type="text" name="data[discount]" class="form-control input-sm" value="{{ $info->discount }}">
	...
	<div class="modal-footer">
        ...
        <div onclick='ajax_submit_form("form_ajax","{{ url('/console/group/edit',['id'=>$info->id]) }}")' name="dosubmit" class="btn btn-info">提交</div>
    </div>
</form>