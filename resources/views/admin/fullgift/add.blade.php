...
<form action="javascript:;" method="post" id="form_ajax">
    ...
    <table class="table table-striped">
        ...
        <tr>
            ...
            <td>
                <input type="number" name="data[price]" min="0" value="{{ old('data.price') }}" class="form-control input-sm">
        ...
        <tr>
            ...
            <td>
                <input type="number" name="data[store]" min="0" value="{{ old('data.store') }}" class="form-control input-sm">
                <p class="input-info"><span class="color_red">*</span>数字</p>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <div class="btn-group">
                    ...
                    <div onclick='ajax_submit_form("form_ajax","{{ url('/console/fullgift/add') }}")' name="dosubmit" class="btn btn-xs btn-info">提交</div>
                </div>
            </td>
        </tr>
