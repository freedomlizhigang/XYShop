<form action="javascript:;" method="post" class="form-inline" id="form_ajax">
    ...
    <table class="table table-striped">
        ...
        <tr>
            ...
            <td>
                <textarea name="data[value]" class="form-control input-lg" rows="5">{{ str_replace('，',PHP_EOL,$info->value) }}</textarea>
    ...
    <div class="modal-footer">
        ...
        <div onclick='ajax_submit_form("form_ajax","{{ url('/console/goodattr/edit',['id'=>$info->id]) }}")' name="dosubmit" class="btn btn-info">提交</div>
    </div>
</form>
<script>
    $(function(){
