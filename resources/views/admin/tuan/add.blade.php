...
<form action="javascript:;" method="post" id="form_ajax">
    ...
    <table class="table table-striped">
        ...
        <tr>
            ...
            <td>
                <input type="text" min="0" name="data[tuan_num]" value="{{ old('data.tuan_num') }}" class="form-control input-xs">
        ...
        <tr>
            ...
            <td>
                <input type="text" min="0" name="data[buy_num]" value="{{ old('data.buy_num') }}" class="form-control input-xs">
        ...
        <tr>
            ...
            <td>
                <input type="text" min="0" name="data[store]" value="{{ old('data.store') }}" class="form-control input-xs">
        ...
        <tr>
            ...
            <td>
                <input type="text" min="0" name="data[price]" value="{{ old('data.price') }}" class="form-control input-xs">
                <p class="input-info"><span class="color_red">*</span>数字</p>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <div class="btn-group">
                    ...
                    <div onclick='ajax_submit_form("form_ajax","{{ url('/console/tuan/add') }}")' name="dosubmit" class="btn btn-xs btn-info">提交</div>
                </div>
            </td>
        </tr>
