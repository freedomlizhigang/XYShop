...
<div class="form_login_bg">
	<section class="box clearfix">
		<div class="login_box_right">
			<h3><span class="tab_t active">忘记密码</span><span class="tab_t getcode">扫码登录</span></h3>
			<div class="tab_login_div">
				<form action="{{ url('/user/forpwd') }}" method="post" class="login_form form-inline">
					{{ csrf_field() }}
					...
					<div class="form-group clearfix">
						...
						<input type="text" class="form-control" name="email" placeholder="请输入密保邮箱...">
					</div>
					<div class="form-group clearfix">
						<input type="submit" class="login_btn" value="发送验证码">
					</div>
				</form>
			</div>
			<div class="tab_login_div dn">
				...
				<p class="text-center">如果绑定了微信号，可以打开<br />手机微信扫码登陆修改密码</p>
